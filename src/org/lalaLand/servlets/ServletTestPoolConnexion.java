 ...
 */
@WebServlet(description = "Servlet destinée à tester la connection à la base de données.", urlPatterns = { "/ServletTestPoolConnexion" })
public class ServletTestPoolConnexion extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			out.print("La connexion est "+(cnx.isClosed()? "fermée ":" ouvert ")+ ".");
